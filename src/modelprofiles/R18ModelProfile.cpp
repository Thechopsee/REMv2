...
std::vector<GroupBlock*> R18ModelProfile::LoadModel() 
{
  ...
  Groups.back()->blocks.push_back(new OnOffBlock(0, 0, {0,4,2,15,32,33},"All", true));
  ...
  Groups.back()->blocks.push_back(new ActionBlock(3, 0, allBlockPins,"Action All", new LinearBlinkAction(), true));
  ...
  Groups.back()->blocks.push_back(new SliderBlock(5,0,allBlockPins,"Slider Lights All", 50));
  ...
  Groups.back()->blocks.push_back(new InputSliderBlock(6,0,allBlockPins,"Input Slider Lights All", 180, 90));
